...
/* Forward declaration for sched_class */
struct sched_class;
...
typedef struct sched_class {
	...
	void (*enqueue_task)(task_t* t,runqueue_t* rq, int preempted);
...
extern sched_class_t prio_multi_sched;
extern sched_class_t mlf_sched;
...
static const sched_choice_t available_schedulers[NR_AVAILABLE_SCHEDULERS]= {
	...
	{PRIO_MULTI_SCHED, "PRIO_MULTI",&prio_multi_sched},
	{MLF_SCHED, "MLF",&mlf_sched},
};
